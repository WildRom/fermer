...
--
-- Table structure for table `farm_fields`
--

CREATE TABLE `farm_fields` (
  `field_id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL,
  `field_no` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `time_s` int(11) NOT NULL DEFAULT 0,
  `field_info` int(11) NOT NULL DEFAULT 0,
  `time_w` int(11) NOT NULL DEFAULT 0,
  `w_qty` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
  `insect` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
  `fertilizer` tinyint(3) UNSIGNED NOT NULL DEFAULT 0
...
--
-- AUTO_INCREMENT for table `farm_fields`
--
ALTER TABLE `farm_fields`
